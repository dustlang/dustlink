...
- Dust-language forge modules (`src/*.ds`) that define linker APIs/constants and current domain behavior stubs.

The Rust CLI is the operational linker entrypoint in this repository state.
